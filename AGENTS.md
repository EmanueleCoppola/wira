...
When a task modifies files under `.agents/docs/`, review this index as part of that task and update it if any path or description is no longer accurate. Do not perform this synchronization check for tasks that do not modify `.agents/docs/`.
